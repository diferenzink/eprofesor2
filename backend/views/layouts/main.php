    ...
    <div id="wrapper">
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
                        <a href="index.php"><i class="fa fa-th-large"></i> <span class="nav-label">Escritorio</span> <span class="fa arrow"></span></a>
                    ...
                    <li>
                        <a href="index.php?r=agrupamientos/index"><i class="fa fa-diamond"></i> <span class="nav-label">Agrupamientos</span> </a>
                    </li>
                    <li>
                        <a href="index.php?r=profesores/index"><i class="fa fa-diamond"></i> <span class="nav-label">Profesores</span> </a>
                    </li>
                    <li>
                        <a href="index.php?r=matricula/index"><i class="fa fa-diamond"></i> <span class="nav-label">Matrícula</span> </a>
                    </li>
                    <li>
                        <a href="index.php?r=alumnado/index"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Alumnado</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="index.php?r=profesores/index"><i class="fa fa-flask"></i> <span class="nav-label">Profesorado</span> </a>
                    </li>
                    <li>
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm text-muted welcome-message">Bienvenido a eProfesor.</span>
                </li>
                <li class="dropdown">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="footer">
                    ...
                    <div>
                        <strong>Copyright</strong> Luis Serrano &copy; 2014-2015
                    </div>
                </div>
            </div>
        </div>
